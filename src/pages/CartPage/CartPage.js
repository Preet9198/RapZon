    ...
    <div className='cart bg-'>
      <div className='container'>
        <div className='cart-ctable'>
          <div className='cart-chead bg-'>
            <div className='cart-ctr fw- font-manrope fs-'>
              ...
              <div className='cart-cth'>
                <span className='cart-ctxt'>Action</span>
              </div>
            </div>
          </div>

          <div className='cart-cbody bg-'>
            {
              carts.map((cart, idx) => {
                return (
                  <div className='cart-ctr py-' key = {cart?.id}>
                    ...
                    <div className='cart-ctd'>
                      <span className='cart-ctxt fw-'>{formatPrice(cart?.totalPrice)}</span>
                    </div>
          ...
          <div className='cart-cfoot flex align-start justify-between py-3 bg-'>
            <div className='cart-cfoot-l'>
              <button type='button' className='clear-cart-btn text-danger fs- text-uppercase fw-' onClick={() => dispatch(clearCart())}>
            ...
            <div className='cart-cfoot-r flex flex-column justify-end'>
              <div className='total-txt flex align-center justify-end'>
                <div className='font-manrope fw-5'>Total {/*itemsCount*/}price :</div>
                <span className=' fs-mx- fw-'>{formatPrice(totalAmount)}</span>
              </div>
